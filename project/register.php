...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <div class="password-container">
         <input type="password" name="cpass" id="confirm_password" required placeholder="Confirm your password" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
